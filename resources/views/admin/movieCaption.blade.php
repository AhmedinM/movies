...
@section('title')
    <title>Unos prevoda za film</title>
@endsection
                    ...
                    <div class="sparkline12-list">
                        <div class="sparkline12-hd">
                            <div class="main-sparkline12-hd">
                                <h1 style="color: white">Unos prevoda za film</h1>
                            </div>
                        </div>
                        @if($errors->any())
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="all-form-element-inner">
                                            <form action="{{url('admin/add-movieCaption/form')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label for="movie" style="color: white" class="login2 pull-right pull-right-pro">Film:</label>
                                                        </div>
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <div class="form-select-list">
                                                                <select required style="color: white" class="form-control custom-select-value" name="movie" id="movie">
                                                                    @foreach ($movies as $m)
