						...
						<div class="row">
							...
							<div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-9">
								<div class="card__content">
									...
									<ul class="card__meta">
										<li><span>{{__('Žanr:')}}</span> <a href="#">{{__('Akcija')}}</a>
										<a href="https://www.youtube.com">{{__('Triler')}}</a></li>
										<li><span>Godina:</span> 2017</li>
										<li><span>Dužina:</span> 120 min</li>
										<li><span>Zemlja:</span> <a href="#">USA</a> </li>
									</ul>
